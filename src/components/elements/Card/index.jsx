    ...
    <>
      <div className="h-[32rem] flexc flex-col overflow-hidden rounded-lg shadow">
        ...
        <div className="flex-[1] bg-white w-full flexc flex-col px-5">
          <p className="relative w-full flexc !justify-start text-2xl flex-[1] text-sky-500">
            {value.name}
            <span className="transcenter !left-[1.4rem] !top-[85%] w-1/6 h-[2px] bg-biru-500"></span>
          </p>
